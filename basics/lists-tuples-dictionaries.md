...
[<< Prev (Strings, Numbers, Booleans)](https://github.com/colinat/Python/blob/main/basics/strings-numbers-and-booleans.md) | [Next >> (if, else, elif)](https://github.com/colinat/Python/blob/main/basics/if-elif-else.md)
